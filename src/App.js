      ...
      <div>
        <Router>
          ...
          <LoadingBar
            ...
            onLoaderFinished={() => this.setProgress(0)} // Reset progress when loader finishes
          />
          ...
          <Routes>
            ...
            <Route
              path="/"
              element={<News setProgress={this.setProgress} key="home" pageSize={5} country="in" category="general" />}
            />
            <Route
              exact
              path="/general"
            ...
            <Route
              exact
              path="/entertainment"
              element={<News setProgress={this.setProgress} key="entertainment" pageSize={5} country="in" category="entertainment" />}
            />
            <Route
              exact
              path="/health"
